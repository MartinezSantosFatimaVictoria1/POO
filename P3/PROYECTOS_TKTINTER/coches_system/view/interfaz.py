...
from controller.controlador import Autos, Camionetas, Camiones 
...
class InterfacesMenu():
    ...
    def coches_agregar(ventana):
        ...
        btnAgregar=Button(ventana,text="Agregar",command= lambda: Autos.insertar_coche(txtMarca.get(),txtColor.get(),txtModelo.get(),txtVelocidad.get(),txtPotencia.get(),txtPlazas.get()))
        btnAgregar.pack(pady=5)
    ...
    def coches_cambiar(ventana,opid):
        ...
        btnGuardar=Button(ventana,text="Guardar",command= lambda: Autos.actualizar_coche(txtMarca.get(),txtColor.get(),txtModelo.get(),txtVelocidad.get(),txtPotencia.get(),txtPlazas.get(),id_modificar.get()))
    ...
    def coches_eliminar(ventana,opid):
        ...
        btnEliminar=Button(ventana,text="Eliminar",command= lambda:Autos.eliminar_coche(id_eliminar.get()))
        btnEliminar.pack(pady=5)
        btnVolver=Button(ventana,text="Volver",command= lambda: InterfacesMenu.menu_acciones(ventana,tipo))
        btnVolver.pack(pady=5)
    ...
    def camiones_agregar(ventana):
        ...
        btnAgregar=Button(ventana,text="Agregar",command= lambda: Camiones.insertar_camion(txtMarca.get(),txtColor.get(),txtModelo.get(),txtVelocidad.get(),txtPotencia.get(),txtPlazas.get(),txtEje.get(),txtCapacidad.get()))
        btnAgregar.pack(pady=5)
        btnVolver=Button(ventana,text="Volver",command= lambda: InterfacesMenu.menu_acciones(ventana,tipo))
        btnVolver.pack(pady=5)
    ...
    def camiones_mostrar(ventana):
        ...
        lblTitulo.pack(pady=5)
        filas=""
        registros=Camiones.mostrar_camion()
    ...
    def camiones_eliminar(ventana, opid=None):
        ...
        btnEliminar=Button(ventana,text="Eliminar",command= lambda: Camiones.eliminar_camion(id_eliminar.get()))
        btnEliminar.pack(pady=5)
        btnVolver=Button(ventana,text="Volver",command= lambda: InterfacesMenu.menu_acciones(ventana,tipo))
        btnVolver.pack(pady=5)
    ...
    def camiones_cambiar(ventana, opid=None):
        ...
        btnGuardar=Button(ventana,text="Guardar",command= lambda: Camiones.actualizar_camion(txtMarca.get(),txtColor.get(),txtModelo.get(),txtVelocidad.get(),txtPotencia.get(),txtPlazas.get(),txtEje.get(),txtCapacidad.get(), id_modificar.get()))
        btnGuardar.pack(pady=5)
        btnVolver=Button(ventana,text="Volver",command= lambda: InterfacesMenu.menu_acciones(ventana,tipo))
        btnVolver.pack(pady=5)
    ...
    def camionetas_agregar(ventana):
        ...
        btnAgregar=Button(ventana,text="Agregar",command= lambda: Camionetas.insertar_camioneta(txtMarca.get(),txtColor.get(),txtModelo.get(),txtVelocidad.get(),txtPotencia.get(),txtPlazas.get(),InterfacesMenu.obtener_seleccion_lbx(lbxTraccion),InterfacesMenu.obtener_seleccion_lbx(lbxCerrada)))
        btnAgregar.pack(pady=5)
        btnVolver=Button(ventana,text="Volver",command= lambda: InterfacesMenu.menu_acciones(ventana,tipo))
        btnVolver.pack(pady=5)
    ...
    def camionetas_mostrar(ventana):
        ...
        lblTitulo.pack(pady=5)
        filas=""
        registros=Camionetas.mostrar_camioneta()
    ...
    def camionetas_eliminar(ventana, opid=None):
        ...
        btnEliminar=Button(ventana,text="Eliminar",command= lambda: Camionetas.eliminar_camioneta(id_eliminar.get()))
        btnEliminar.pack(pady=5)
        btnVolver=Button(ventana,text="Volver",command= lambda: InterfacesMenu.menu_acciones(ventana,tipo))
        btnVolver.pack(pady=5)
    ...
    def camionetas_cambiar(ventana, opid=None):
        ...
        btnGuardar=Button(ventana,text="Guardar",command= lambda: Camionetas.actualizar_camioneta(txtMarca.get(),txtColor.get(),txtModelo.get(),txtVelocidad.get(),txtPotencia.get(),txtPlazas.get(),InterfacesMenu.obtener_seleccion_lbx(lbxTraccion),InterfacesMenu.obtener_seleccion_lbx(lbxCerrada), id_modificar.get()))
        btnGuardar.pack(pady=5)
        btnVolver=Button(ventana,text="Volver",command= lambda: InterfacesMenu.menu_acciones(ventana,tipo))
        btnVolver.pack(pady=5)
