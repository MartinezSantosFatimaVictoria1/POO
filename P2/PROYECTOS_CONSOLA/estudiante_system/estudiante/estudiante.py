...
estudiante1 = Estudiante("Dominic Toretto", 8)
estudiante1.mostrar_cali(estudiante1._nombre, estudiante1._nota)


estudiante2 = Estudiante("Roberto Gomez Bolanos", 5)
estudiante2.mostrar_cali(estudiante2._nombre, estudiante2._nota)


estudiante3 = Estudiante("Brayan O'Conner", 9)
estudiante3.mostrar_cali(estudiante3._nombre, estudiante3._nota)
